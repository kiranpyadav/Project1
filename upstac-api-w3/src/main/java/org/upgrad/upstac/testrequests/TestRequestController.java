...
public class TestRequestController {
	...
	/*
	 * This function will create new test request. It will perform validation of
	 * testRequest data. If a record with same Phone number and Email Id exists
	 * with current logged user and its Status is not 'Completed' then it will
	 * throw AppException otherwise New Request will be saved.
	 */
	...
	/*
	 * This function return all the Test Request created by logged user.
	 * 
	 */
	...
	/*
	 * This function return Test Request by User Id
	 * 
	 */
