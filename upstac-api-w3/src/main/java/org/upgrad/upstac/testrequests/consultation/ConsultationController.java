...
public class ConsultationController {
    ...
    /*
	 * This function returns all the Test Request with Status as 'LAB_TEST_COMPLETED'
	 * 
	 */
    @GetMapping("/in-queue")
	...
	/*
	 * This function returns list of TestRequest for the logged User as Doctor Role
	 * 
	 */
    @GetMapping
    @PreAuthorize("hasAnyRole('DOCTOR')")
    ...
    /*
	 * This function will assigned the ownership to logged in Doctor.
	 * 
	 */
    @PreAuthorize("hasAnyRole('DOCTOR')")
    ...
    /*
	 * This function will update the Consultation Remarks  results parameters or Patient feedback as 
	 * entered by user with Doctor role
	 */
    @PreAuthorize("hasAnyRole('DOCTOR')")
